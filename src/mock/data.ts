...
export const INITIAL_CAMERAS: Camera[] = [
  {
    id: 'CAM-FENCE-03',
    name: 'CAM-FENCE-03',
    location: 'Perimeter Fence B (Zero Line)',
    bop: 'BOP-17',
    zone: 'Zone Fence-B',
    type: 'IR',
    resolution: '720p',
  ...
  },
  {
    ...
    streamType: 'optical',
    isPtzBackup: true,
    backupTargetCamId: 'CAM-FENCE-03',
    detectedObjects: []
  },
  {
    id: 'CAM-GATE-02',
    name: 'CAM-GATE-02',
    location: 'Entry Checkpoint Gate',
    bop: 'BOP-17',
  ...
  },
  {
    id: 'CAM-04',
    name: 'CAM-04',
    location: 'East Tower / Service Junction',
    bop: 'BOP-17',
  ...
  },
  {
    id: 'CAM-TOWER-01',
    name: 'CAM-TOWER-01',
    location: 'Watchtower High-Overwatch 1',
    bop: 'BOP-17',
  ...
  },
  {
    id: 'CAM-11',
    name: 'CAM-11',
    location: 'South Sector Line / Utility Yard',
    bop: 'BOP-17',
    zone: 'Zone South-11',
    type: 'IR',
    resolution: '1080p',
  ...
  {
    id: 'CAM-PERIMETER-08',
    name: 'CAM-PERIMETER-08',
    location: 'Extended Perimeter Boundary East',
    bop: 'BOP-17',
    zone: 'Zone East-08',
    type: 'Fixed',
    resolution: '1080p',
  ...
  },
  {
    id: 'CAM-VALLEY-09',
    name: 'CAM-VALLEY-09',
    location: 'Depression & Valley Approach',
    bop: 'BOP-17',
    zone: 'Zone Valley-09',
    type: 'Fixed',
    resolution: '1080p',
  ...
  },
  {
    id: 'CAM-BARRIER-10',
    name: 'CAM-BARRIER-10',
    location: 'Service Road Barrier Junction',
    bop: 'BOP-17',
    zone: 'Zone Barrier-10',
    type: 'PTZ',
    resolution: '1080p',
    fps: 25,
    latencyMs: 38,
...
export const INITIAL_INCIDENTS: Incident[] = [
  ...
  {
    id: 'INC-2026-0144',
    title: 'Perimeter crawling motion signature',
    severity: 'HIGH',
    status: 'CONFIRMED',
    timestamp: '02:05:30 IST',
    location: 'Sector East / Ridge 6',
    bop: 'BOP-17',
    zone: 'Zone Ridge-6',
    primaryCamera: 'CAM-06',
    cameras: ['CAM-06', 'CAM-04'],
    objectType: 'PERSON',
    objectCount: 1,
    trackId: 'T-119',
    direction: 'East → South-East',
    persistenceSeconds: 36,
    confidence: 0.89,
    riskScore: 81,
    description: 'Low-profile crawl signature identified via thermal infrared feed along dry gully. Corroborated across adjacent sensor node CAM-04.',
    timeline: [
      { time: '02:05:30 IST', title: 'Thermal Acquisition', description: 'CAM-06 IR detected prone thermal signature', type: 'DETECTION' },
      { time: '02:05:48 IST', title: 'SWAN Confirmation', description: 'Trajectory linked to Ridge 6 gully line', type: 'SWAN_CONFIRM' }
    ],
    notes: [],
    assignedTo: 'OP-042',
    evidenceIds: [],
  ...
  {
    id: 'INC-2026-0145',
    title: 'Fast-moving target on boundary dirt track',
    severity: 'HIGH',
    status: 'NEW',
    timestamp: '02:01:40 IST',
    location: 'North Track Outer Line',
    bop: 'BOP-17',
    zone: 'Zone North-Outer',
    ...
    persistenceSeconds: 52,
    confidence: 0.88,
    riskScore: 74,
    description: 'Unidentified light utility vehicle detected traveling at 38 km/h parallel to fence corridor without clearance beacon.',
    timeline: [
      { time: '02:01:40 IST', title: 'Radar/Optical Trigger', description: 'High-speed track classified by YOLO edge node', type: 'DETECTION' }
    ],
    notes: [],
    assignedTo: undefined,
    evidenceIds: [],
  ...
  {
    id: 'INC-2026-0146',
    title: 'Loitering near culvert drainage channel',
    severity: 'HIGH',
    status: 'ASSIGNED',
    timestamp: '01:58:22 IST',
    location: 'Culvert Bravo-4',
    bop: 'BOP-17',
    zone: 'Zone Culvert-B4',
    primaryCamera: 'CAM-06',
    cameras: ['CAM-06'],
    objectType: 'PERSON',
    objectCount: 1,
    direction: 'Stationary',
    persistenceSeconds: 68,
    confidence: 0.85,
    riskScore: 68,
    description: 'Individual detected loitering inside water culvert drainage buffer. QRT patrol dispatched to conduct visual verification.',
    timeline: [
      { time: '01:58:22 IST', title: 'Loiter Alert', description: 'Duration > 60s within restricted drainage buffer', type: 'DETECTION' }
    ],
    notes: [],
    assignedTo: 'OP-042',
    evidenceIds: [],
  ...
  {
    id: 'INC-2026-0147',
    title: 'Thermal hotspot beyond buffer strip',
    severity: 'LOW',
    status: 'NEW',
    timestamp: '01:48:10 IST',
    location: 'Tower East Clear Zone',
    bop: 'BOP-17',
    zone: 'Zone Tower-East',
    primaryCamera: 'CAM-TOWER-01',
    cameras: ['CAM-TOWER-01'],
    objectType: 'ANOMALY',
    objectCount: 1,
    direction: 'Static',
    ...
    confidence: 0.79,
    riskScore: 45,
    description: 'Localized heat signature detected 120m beyond buffer strip. PTZ slewed to acquire optical confirmation.',
    timeline: [
      { time: '01:48:10 IST', title: 'Thermal Anomaly', description: 'Temperature delta +4.2°C above ambient ground', type: 'DETECTION' }
    ],
    notes: [],
    assignedTo: undefined,
    evidenceIds: [],
  ...
  {
    id: 'INC-2026-0148',
    title: 'Low-altitude optical anomaly detected',
    severity: 'LOW',
    status: 'ASSIGNED',
    timestamp: '01:43:30 IST',
    location: 'Air Corridor South-East',
    bop: 'BOP-17',
    zone: 'Zone Patrol-South',
    primaryCamera: 'CAM-ROAD-05',
    cameras: ['CAM-ROAD-05'],
    objectType: 'ANOMALY',
    objectCount: 1,
    direction: 'East → West',
    ...
    confidence: 0.81,
    riskScore: 42,
    description: 'Small rotary-wing acoustic and optical signature registered at 45m altitude. Radio frequency scanner scanning for uplink telemetry.',
    timeline: [
      { time: '01:43:30 IST', title: 'Acoustic / Optical Trip', description: 'Micro-UAV signature detected by high-mast camera', type: 'DETECTION' }
    ],
    notes: [],
    assignedTo: 'SUP-011',
    evidenceIds: [],
  ...
  {
    id: 'INC-2026-0149',
    title: 'Perimeter acoustic-sensor trip ping',
    severity: 'LOW',
    status: 'NEW',
    timestamp: '01:38:15 IST',
    location: 'Sector Link 11 Post',
    bop: 'BOP-17',
    zone: 'Zone South-11',
    ...
    objectType: 'ANOMALY',
    objectCount: 1,
    direction: 'Perimeter Boundary',
    persistenceSeconds: 12,
    confidence: 0.76,
    riskScore: 38,
    description: 'Geophone line trip sensor registered ground vibration near fence anchor 14. Camera CAM-11 initiated auto-patrol sweep.',
    timeline: [
      { time: '01:38:15 IST', title: 'Sensor Trip', description: 'Vibration pattern characteristic of fence contact', type: 'DETECTION' }
    ],
    notes: [],
    assignedTo: undefined,
    evidenceIds: [],
